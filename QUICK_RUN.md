...
$env:TEST_BASE_URL="https://test.miapp.example.com/app/auth"
$env:TEST_USERNAME="mi_usuario_test"
$env:TEST_PASSWORD="mi_clave_test"
.\gradlew test "-Dcucumber.filter.tags=@Smoke"

# Apuntar a UAT (requiere credenciales de UAT)
$env:TEST_BASE_URL="https://uat.miapp.example.com/app/auth"
...
```powershell
.\gradlew test `
    "-Dbase.url=https://test.miapp.example.com/app/auth" `
...
cd D:\proyectos\qa-automation-framework
.\gradlew clean compileTestJava
```
