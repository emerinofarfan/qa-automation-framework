...
✅ **Enterprise Patterns**: Test architecture designed following production-grade practices
...
# Optional: run full suite including destructive tests (explicit opt-in)
./gradlew testAll
```
